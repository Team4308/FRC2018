...
public class SynchronousPID {
    ...
    public double m_PTermVal; // The value of the P calc
    public double m_ITermVal; // The value of the I calc
    public double m_DTermVal; // The value of the D calc
    ...
    public double calculate(double input) {
        ...
        m_PTermVal = m_P * proportionalError;
    ...
    public String getValues() {
        ...
        pidVals = "P Term Val: " + m_PTermVal + " D Term Val: " + m_DTermVal + " Output: " + m_result;
